...
class Player(tk.Frame):
	...
	def create_frames(self):
		self.track = tk.LabelFrame(self, text='Music System', 
					font=("times new roman",15,"bold"),
					bg="green",fg="white",bd=5,relief=tk.GROOVE)
	...
	def track_widgets(self):
		...
		self.songtrack = tk.Label(self.track, font=("times new roman",14,"bold"),
						bg="white",fg="red")
	...
	def control_widgets(self):
		self.loadSongs = tk.Button(self.controls, bg='purple', fg='white', font=10)
	...
	def play_song(self, event=None):
		...
		self.list.itemconfigure(self.current, bg='pink')
